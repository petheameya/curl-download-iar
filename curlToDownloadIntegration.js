...
/*
    Now start uploading file that we downloaded
*/

const curlUpload = new Curl();
...
curlUpload.setOpt(Curl.option.URL, 'https://swoicqa1-sherwinwilliamsoci.integration.ocp.oraclecloud.com:443/ic/api/integration/v1/integrations/archive');
//curlDownload.setOpt(curlDownload.option.USERNAME, '');
curlUpload.setOpt(Curl.option.USERPWD, 'Geaintsoadev1:SellmorepaintSOA18*');
curlUpload.setOpt(Curl.option.SSL_VERIFYHOST, 0);
curlUpload.setOpt(Curl.option.HTTPPOST, data);
curlUpload.setOpt(Curl.option.SSL_VERIFYPEER, 0);
curlUpload.setOpt(Curl.option.VERBOSE, true);

curlUpload.on('end', function(statusCode, body){
...
curlUpload.on('error', function(error, errorCode){
